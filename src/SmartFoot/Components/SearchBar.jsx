      ...
      <div className="flex justify-center fixed bottom-8 mx-auto px-4 w-[80%]">
        ...
        >
          <input
            ...
            className={`flex-grow p-3 border rounded-l-md focus:outline-none ${theme === 'dark' ? 'bg-gray-700 text-white border-gray-600' : 'border-slate-700'} focus:ring-2 ${theme === 'dark' ? 'focus:ring-white' : 'focus:ring-slate-700'} hover:outline-1`}
          />
          <button
            type="submit"
